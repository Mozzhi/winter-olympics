<template>
  <div class="charm-inner-mongolia">
    <header-bar active="charm"></header-bar>
    <div class="centerMain wrapper">
      ...
      <div class="list-devide">
        <block-item block-name="内蒙古概况" class="no-more">
          <div class="parts clearfix" slot="blockContent">
            ...
            <a href="" class="inline-box part-item" v-bg="'http://file02.16sucai.com/d/file/2015/0128/8b0f093a8edea9f7e7458406f19098af.jpg'">
